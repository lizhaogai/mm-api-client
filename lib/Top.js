...
class Top {
  ...
  /**
   * Fetches hasOne relation help.
   *
   * @method
   * @path [GET] /Tops/{id}/help
   * @name Top#getHelp
   * @param {string} id - Top id
  ...
  getHelp(id, opts, cb) {
    ...
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling getHelp");
    }
    ...
    const path = utils.buildPath('/Tops/{id}/help', {
      id: id,
    });
  ...
  /**
   * Creates a new instance in help of this model.
   *
   * @method
   * @path [POST] /Tops/{id}/help
   * @name Top#createHelp
   * @param {string} id - Top id
   * @param {object|function|*} [opts] - Optional params
   ...
   * @param {function} [cb] - Callback function
   */
  createHelp(id, opts, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling createHelp");
    }
    if (typeof opts === 'function') {
      cb = opts;
      opts = null;
  ...
  /**
   * Update help of this model.
   *
   * @method
   * @path [PUT] /Tops/{id}/help
   * @name Top#updateHelp
   * @param {string} id - Top id
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - data
   * @param {function} [cb] - Callback function
   */
  updateHelp(id, opts, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling updateHelp");
    }
    if (typeof opts === 'function') {
      cb = opts;
      opts = null;
  ...
  /**
   * Deletes help of this model.
   *
   * @method
   * @path [DELETE] /Tops/{id}/help
   * @name Top#destroyHelp
   * @param {string} id - Top id
   * @param {function} [cb] - Callback function
   */
  destroyHelp(id, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling destroyHelp");
    }
   ...
   *
   * @method
   * @path [POST] /Tops/replaceOrCreate
   * @name Top#replaceOrCreateViaPost
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - Model instance data
   * @param {function} [cb] - Callback function
   */
  replaceOrCreateViaPost(opts, cb) {
    ...
    const path = '/Tops/replaceOrCreate';
   ...
   *
   * @method
   * @path [POST] /Tops/upsertWithWhere
   * @name Top#upsertWithWhere
   * @param {object|function|*} [opts] - Optional params
  ...
  upsertWithWhere(opts, cb) {
    ...
    const path = '/Tops/upsertWithWhere';
  ...
  exists(id, cb) {
    ...
    const path = utils.buildPath('/Tops/{id}/exists', {
      id: id,
    });
  ...
  existsViaHead(id, cb) {
    ...
    const path = utils.buildPath('/Tops/{id}', {
      id: id,
    });
   ...
   *
   * @method
   * @path [POST] /Tops/{id}/replace
   * @name Top#replaceByIdViaPost
   * @param {string} id - Model id
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - Model instance data
   * @param {function} [cb] - Callback function
  ...
  replaceByIdViaPost(id, opts, cb) {
    ...
    const path = utils.buildPath('/Tops/{id}/replace', {
      id: id,
    });
   ...
   *
   * @method
   * @path [POST] /Tops/change-stream
   * @name Top#createChangeStreamViaPost
   * @param {object|function|*} [opts] - Optional params
   ...
   *
   * @method
   * @path [GET] /Tops/change-stream
   * @name Top#createChangeStream
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.options] - options
   * @param {function} [cb] - Callback function
   */
